...
## Introduction
Teledermatology has expanded rapidly under access pressures, but poor patient-generated imagery remains a significant limitation to utility. Clinicians report losing 15 to 30% of asynchronous cases to unreadable photos, and remote workflows offer limited opportunities for real-time coaching. Emerging vision-language models (VLMs) promise rapid triage, yet their sensitivity hinges on image fidelity. Prior work has explored generic blind image quality assessment, but dermatology-specific DIQA gating and its downstream safety impact remain under-studied.
