...
Urgent recall gains concentrate in the darker cohorts: Type VI improves by +6.3 percentage points (77.5% to 83.8%) with an 18.7% retake rate, while Type V gains +4.3 points (67.4% to 71.7%).
...
Monk groupings mirror the aforementioned Fitzpatrick trends: MST 8-10 gains +5.4 urgent-recall points (70.7% to 76.1%) with an 18.5% retake rate, while lighter MST 1-3 tones remain within 3.3 points of baseline recall (76.3% to 79.6%). Figure 4 shows urgent miss reductions persist across all three aggregated tone groupings.
